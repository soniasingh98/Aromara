  ...
  return (
    ...
    <div className="section1-outer">
      <div className="section1-inner2">
        <Image className="illustration-img" src={coffee1} alt="illustration" />
      </div>
     
      <div className="section1-inner1">
        
        <h1>Where Every Sip Unfolds a New Story</h1>
        <h3>Aromara Coffee offers a premium blend that combines rich, aromatic flavors with the finest beans from around the world.</h3>
        <Link href="/explore" className="section1-link">Explore→</Link>
      </div>
      <div className="section1-inner3">
        <Image className="illustration-img" src={illustrationImg} alt="illustration" />
      </div>
    </div>
    </section>
    <section className="section2">
      ...
      <div className="section2-inner1">
        ...
        <h1><span className="section2-span">The Best</span> Brews of the Year</h1>
      </div>
      ...
      <div className="section2-inner3">
        <p className="section2-para1">Discover the top coffee blends of the year, from timeless classics to the latest trendy roasts.</p>
        <p className="section2-para2"> Find your perfect brew and savor the rich, aromatic flavors that make each cup unforgettable.</p>
      </div>
      </div>
    </section>
      ...
      <div className="section3-outer">
        ...
        <div className="section3-inner">
          <div className="section3-inner1">
             <div className="content-div first">3 out of 4 coffee drinkers trust our quality</div>
          ...
          <div className="section3-inner3">
            ...
            <div className="content-div second">Honest ingredients, unparalleled taste</div>
          </div>
        </div>
      </div>
    </section>
